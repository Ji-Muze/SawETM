...
parser.add_argument('--topic_size', type=list, default=[50, 50, 50, 50, 50, 50, 50, 50, 50, 50], help='Number of units in hidden layer 1.')
parser.add_argument('--hidden_size', type=int, default=[50, 50, 50, 50, 50, 50, 50, 50, 50, 50], help='Number of units in hidden layer 1.')
...
#trainer.vis_txt(outpath='./phi_output/put3')
#trainer.vis()
print("Finish")
