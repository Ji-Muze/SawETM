...
parser.add_argument('--topic_size', type=list, default=[50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50], help='Number of units in hidden layer 1.')
parser.add_argument('--hidden_size', type=int, default=[50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50], help='Number of units in hidden layer 1.')
...
parser.add_argument('--output_dir', type=str, default='torch_phi_output_etm_hier_share', help='type of dataset.')
parser.add_argument('--save_path', type=str, default='saves/gbn_model_weibull_etm_share_50_7_kl_0.1', help='type of dataset.')
parser.add_argument('--word_vector_path', type=str, default='../process_data/20ng_word_embedding.pkl', help='type of dataset.')
parser.add_argument('--device', type=str, default='cuda:0', help='train device')
parser.add_argument('--use_pal', type=bool, default=False, help='if use palmetto to calc TC')
...
args.n_updates = len(test_loader) * args.epochs
args.MBratio = len(test_loader)

trainer = GBN_trainer(args,  voc_path=voc)
#trainer.train(train_loader)
#_best_cluster(args, trainer, test_loader)
for epoch in range(args.epochs):
    trainer.vis_txt(epoch)
print("Finish")